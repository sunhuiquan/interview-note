...
如果题目中发现有说连续的子串、子数组，只要有连续二字，一定要思考是不是滑动窗口的题型。

76 424 480 594 930 932 978 992 1004 1052 1208 1234 1248 1423 1438 1610 1658 1838 1984 2024
...
|LC487 Medium|可变窗口，记录可以反转的次数和上一次遇到 0 的位置，如果遇到第二个 0，那么循环左移 l 到上一个 0 的后一个位置，然后外层循环 r 可以继续。|
